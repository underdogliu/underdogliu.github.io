...
url: /2025-12-30-yearly-summary/
author: "Xuechen Liu"
description: "Refresh. Prepared."
summary: "Even a more casual summary than last year. Since my 1st draft is too casual (with swearings), I asked ChatGPT to polish."
showToc: false
...
- [Tottenham won the Europa League](https://en.wikipedia.org/wiki/2025_UEFA_Europa_League_final). The last time they [won a major trophy](https://en.wikipedia.org/wiki/2008_Football_League_Cup_final), I was in my middle school. If we don't count Carabao Cup as "major", I wasn't even alive when they [won the last FA cup](https://en.wikipedia.org/wiki/1991_FA_Cup_final). So, I guess I'm pretty lucky on witnessing this one. It is a Team win, an Ange win, and a [Sonny win](https://www.tottenhamhotspur.com/news/2025/july/heung-min-son-announces-intention-to-leave-the-club).
- Indiana pulled off [so many miracles in last season’s playoffs](https://www.youtube.com/watch?v=PaDENaigPfk), and made it to the finals --- [even almost won the champion](https://www.espn.co.uk/nba/story/_/id/45445853/2025-nba-finals-biggest-takeaways-thunder-pacers-championship). I’m not gonna get into refs or the NBA “grand plan” from Mr. Silver. It is what it is. The run itself—the process, the memories—that’s the part worth keeping. I’ll remember it for a long time… until we actually win it.
...
**Finish more marathons**. Earlier this year, I finished hopefully the marathon of my life - [Tokyo Marathon 2025](https://www.marathon.tokyo/en/about/past/2025). Nothing “special” about the race itself, but despite all odds, I hit the pace I wanted. A lot of interesting stuff happened along the way though—and I still haven’t had the time to properly recap it. Maybe next year I’ll write a separate post. 
I also have finished [a half marathon](https://minato-half.jp) later this year casually, and the organization/activities kinda disappointed me a bit LOL.
...
- [Osaka](https://en.wikipedia.org/wiki/Osaka), due to [IEEE IJCB 2025](https://ijcb2025.ieee-biometrics.org/), with the lab I'm working in
